...
class LaST(BaseDataset):
    ...
    def __init__(self, root='data', verbose=True, **kwargs):
        ...
        self.num_query_test_pids, self.num_query_test_imgs, self.num_query_test_cams,self.num_query_tset_vids = self.get_imagedata_info(self.query_test)
    ...
    def print_dataset_statistics_movie(self, train, query, gallery, query_test, gallery_test):
        num_train_pids, num_train_imgs, num_train_cams, num_train_vids = self.get_imagedata_info(train)
        num_query_pids, num_query_imgs, num_query_cams, num_query_vids = self.get_imagedata_info(query)
        num_gallery_pids, num_gallery_imgs, num_gallery_cams, num_gallery_vids = self.get_imagedata_info(gallery)
        num_query_test_pids, num_query_test_imgs, num_query_test_cams, num_query_test_vids = self.get_imagedata_info(query_test)
        num_gallery_test_pids, num_gallery_test_imgs, num_gallery_test_cams, num_gallery_test_vids = self.get_imagedata_info(gallery_test)
