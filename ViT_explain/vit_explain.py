...
if __name__ == '__main__':
    args = get_args()
    # model = torch.hub.load('/checkpoint', 'transformer_120.pth', source='local')
    _, _, _, _, _, camera_num, view_num, dataset_train = make_dataloader(cfg, pseudo_labeled_dataset=None)
